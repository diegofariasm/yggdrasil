...
with lib; rec {
  ...
  */
  modulesToList = attrs: let
    paths = collect builtins.isPath attrs;
  in
    builtins.map (path: import path) paths;
  ...
  */
  ...
  getSecrets = sopsFile: secrets: let
